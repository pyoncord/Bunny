...
import { createFindProxy } from "./proxy";
...
export const findByPropsProxy = (...props: string[]) => createFindProxy(byProps(...props));
...
export const findByNameProxy = (name: string, expDefault = true) => createFindProxy(expDefault ? byName(name) : byName.byRaw(name));
...
export const findByDisplayNameProxy = (name: string, expDefault = true) => createFindProxy(expDefault ? byDisplayName(name) : byDisplayName.byRaw(name));
...
export const findByTypeNameProxy = (name: string, expDefault = true) => createFindProxy(expDefault ? byTypeName(name) : byTypeName.byRaw(name));
...
export const findByStoreNameProxy = (name: string) => createFindProxy(byStoreName(name));

export const findByFilePath = (path: string) => findExports(byFilePath(path));
export const findByFilePathProxy = (path: string) => createFindProxy(byFilePath(path));
